namespace DuckSimulator
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.button2.Text = "Добавить место для уточки";
			...
			this.button1.Text = "Купить уточку";
			...
			this.tableLayoutPanel1.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.tableLayoutPanel1.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.tableLayoutPanel1.Size = new System.Drawing.Size(167, 98);
			...
			this.groupBox2.Text = "Ваше озеро";
			// 
			// label4
			// 
			...
			this.Name = "Form1";
			this.ShowIcon = false;
			this.Text = "Симулятор уточек на С#";
